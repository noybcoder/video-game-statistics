...
first_primary_key = 'games'
second_primary_key = 'genres'

def create_junction_table(conn, first_primary_key, second_primary_key):
...
def create_direct_link_table():
    pass

def get_singular_entity_name(attribute):
    return f'{attribute[:-1]}_id'
